...
from gedi_streams.features.feature_extraction import _is_feature_class
...
def test_is_feature_class():
    PASCAL_INPUT = 'NTracesPerWindow'
    SNAKE_INPUT = 'simple_stream_stats'
